...
singleDayView page nav c notice errs = makeView renderPublic $ ViewRep (formatTime "%Y-%m-%d" $ E.pageDay page) $ do
  H.callTemplate "day"
    ...
    , ("lupo:comments", H.mapSplices I.comment $ E.pageComments page)
...
entryEditorView :: E.Saved E.Entry -> T.Text -> (U.URLMapper -> U.Path) -> V.View LupoHandler
...
entryPreviewView :: E.Saved E.Entry -> T.Text -> (U.URLMapper -> U.Path) -> V.View LupoHandler
